package com.example.classlink.ui.faculty;
...
import com.example.classlink.R;
...
public class FacultyFragment extends Fragment {
    ...
    private List<com.example.classlink.ui.faculty.TeacherData> list1, list2, list3 , list4;
    private com.example.classlink.ui.faculty.TeacherAdapter adapter;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    for (DataSnapshot snapshot: dataSnapshot.getChildren()){
                        com.example.classlink.ui.faculty.TeacherData data = snapshot.getValue(com.example.classlink.ui.faculty.TeacherData.class);
                        list1.add(data);
                    }
                    csDepartment.setHasFixedSize(true);
                    csDepartment.setLayoutManager(new LinearLayoutManager(getContext()));
                    adapter = new com.example.classlink.ui.faculty.TeacherAdapter(list1, getContext());
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    adapter = new com.example.classlink.ui.faculty.TeacherAdapter(list2, getContext());
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    adapter = new com.example.classlink.ui.faculty.TeacherAdapter(list3, getContext());
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    adapter = new com.example.classlink.ui.faculty.TeacherAdapter(list4, getContext());
